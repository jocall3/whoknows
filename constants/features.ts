...
export const PILLAR_FEATURES = {
    ...
    'pillar-three-meta-creation': [
        ...
        { id: "themis-engine", name: "The Themis Engine", description: "A legal code refactor. Outputs a new, perfectly logical and ruthlessly efficient legal framework.", icon: <HammerIcon /> },
